...
define(function () {
    require([app.path+"Collections/Product"],function(){
        ...
        App.View('Products', {
            ...
            cnt: 1,
            head: [{ name: 'Name' }, { name: 'Version' }, { name: 'Link' }],
            products: app.Collections.Product([{ name: 'HTML', version:"5.0", link: "w3.org" }, { name: 'CSS', version:"3.0", link: "w3.org" }, { name: 'JavaScript', version:"6.0", link: "w3.org" }]),
            click: function(){
                this.cnt++;
                this.products.add({ name: 'Element '+this.cnt, version:"5.0", link: "w3.org" });
